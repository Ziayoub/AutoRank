                            ...
                            <div class="col-md-8">
                                <h4 class="card-title">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('car',1) }}">Renault Clio 4 </a>
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="col-md-8">
                                <h4 class="card-title">
                                    <div class="d-flex justify-content-between">
                                        <a href="/car">Peugeot 208</a>
                                        <h5 class="text-right">250 <small>DH/Jour</small></h5>
                                    </div>
                                </h4>
                                <p class="card-text">
                                <div class="mb-2">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="col-md-8">
                                <h4 class="card-title">
                                    <div class="d-flex justify-content-between">
                                        <a href="/car"> Citroen Birlingo</a>
                                        <h5 class="text-right">500 <small>DH/Jour</small></h5>
                                    </div>
                                </h4>
                                <p class="card-text">
                                <div class="mb-2">
