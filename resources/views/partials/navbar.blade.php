        ...
        <ul class="navbar-nav ml-auto d-flex align-items-center">
          ...
          <li class="nav-item dropdown ml-4">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
              <a class="dropdown-item text-uppercase text-letter-spacing text-sm" href="login.html">
                Se Connecter
              </a>
              <a class="dropdown-item text-uppercase text-letter-spacing text-sm" href="register.html">
                Créer un compte
              </a>
            </div>
          </li>
          ...
          <!-- <li class="nav-item dropdown ml-4">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                ...
                <a class="dropdown-item text-uppercase text-letter-spacing text-sm" href="#">Se Déconnecter</a>
              </div>
            </li> -->
